// ================================================================
//  🚗 GeoFS — BMW E30 M3 ADDON v1.0 FINAL
...
(function () {
  ...
  var BMW_E30 = {
    ...
    emoji: '🔵',
    color: '#1a4fa0',
    modelUrl: 'https://files.catbox.moe/urjzbq.glb',  // ← TON FICHIER !
    geofsId: 102,  // Base: Citroën 2CV
    physics: {
    ...
    description: 'Groupe A • 4 cyl 2.3L • 195ch • 1200kg',
    badge: 'GROUP A'
  };
